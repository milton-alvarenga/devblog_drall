...
<link rel='stylesheet' id='no_captcha_css-css'  href='/wp-content/plugins/login-form-recaptcha/css/no-captcha.css' type='text/css' media='all' />
...
<!-- end SI CAPTCHA Anti-Spam - login/register form style -->
	...
	<script type="text/javascript">
		...
		<form name="loginform" id="loginform" action="http://devblog.drall.com.br/wp-login.php" method="post">
			<p>
			...
			<p class="cptch_block"><span class="cptch_wrap cptch_math_actions">
				<label class="cptch_label" for="cptch_input_61"><span class="cptch_span"><input id="cptch_input_61" class="cptch_input cptch_wp_login" type="text" autocomplete="off" name="cptch_number" value="" maxlength="2" size="2" aria-required="true" required="required" style="margin-bottom:0;display:inline;font-size: 12px;width: 40px;" /></span>
					<span class="cptch_span">&nbsp;&times;&nbsp;</span>
					<span class="cptch_span">fi&#118;&#101;</span>
					<span class="cptch_span">&nbsp;=&nbsp;</span>
					<span class="cptch_span">5</span>
					<input type="hidden" name="cptch_result" value="BLE=" /><input type="hidden" name="cptch_time" value="1636897340" />
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In" />
									<input type="hidden" name="redirect_to" value="http://devblog.drall.com.br/wp-admin/post.php" />
									<input type="hidden" name="testcookie" value="1" />
			</p>
		</form>

					<p id="nav">
								<a href="/wp-login.php">Lost your password?</a>
			</p>
					<script type="text/javascript">
...
/* <![CDATA[ */
var _zxcvbnSettings = {"src":"http:\/\/devblog.drall.com.br\/wp-includes\/js\/zxcvbn.min.js"};
/* ]]> */
</script>
