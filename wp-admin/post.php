	...
	<script type="text/javascript">
		...
		<form name="loginform" id="loginform" action="http://devblog.drall.com.br/wp-login.php" method="post">
			...
			<p class="cptch_block"><span class="cptch_wrap cptch_math_actions">
				<label class="cptch_label" for="cptch_input_34"><span class="cptch_span">thr&#101;e</span>
					...
					<input type="hidden" name="cptch_result" value="ec8=" /><input type="hidden" name="cptch_time" value="1602097833" />
